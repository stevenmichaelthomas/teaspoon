(function() {
  ...
  this.Runner = (function() {
    ...
    Runner.prototype.waitForResults = function() {
      ...
      var finished = this.page.evaluate(function() {
        console.log(window.Teaspoon, window.Teaspoon.finished);
        return window.Teaspoon && window.Teaspoon.finished;
      });

      var testTeaspoon = this.page.evaluate(function () {
        return window.Teaspoon;
      })

      console.log('LOGGING window.Teaspoon')
      console.log(testTeaspoon)

      var testTeaspoonFinished = this.page.evaluate(function () {
        return window.Teaspoon;
      })

      console.log('LOGGING window.Teaspoon.finished')
      console.log(testTeaspoonFinished)
